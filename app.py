...
partie1_md = '''
    ...
    - Quel est le profil des opérations soutenues et quel niveau d’aide reçoivent-ils ?
...
partie6_md = '''
    ...
    **Selon qu’elles soient conduites outre-mer ou en métropole, les actions de renforcement de la cohésion économique, sociale et territoriale soutenues par le FEDER et le FSE présentent des différences qui se traduisent notamment par le cofinancement d’acteurs différents.**
    ...
    Les entreprises bénéficient également en outre-mer de davantage de financements européens, en raison de l’existence de mesures de compensation des surcoûts de l’ultrapériphéricité. En revanche, les conseils régionaux et établissements d’enseignement supérieur et de recherche occupent une place moindre que dans les régions métropolitaines dites « en transition » et « plus développées ».
'''

partie7_md = '''
    ## 7. Des stratégies d’emploi des fonds différentes selon les régions

    Les stratégies de sélection des opérations par les Conseils régionaux, autorités de gestion de la plupart des programmes opérationnels, s’est traduite par un ciblage des investissements qui a pu bénéficier à certaines catégories de bénéficiaires.
...
partie8_md = '''
    ...
    Hors instruments financiers, une centaine d’opérations présente une contribution européenne supérieure à 10 millions d’euros. Elles représentent 0,3% des opérations mais 19,4% des contributions FEDER et FSE.
...
partie9_md = '''
    ...
    **Une partie des financements FEDER a été allouée à la mise en place d’une soixantaine d’instruments financiers, c’est-à-dire des dispositifs d’aide remboursable représentant un total de plus de 354 millions d’euros.**
...
apropos_md = '''
    ...
    Romain SU, https://romain.su
    
    Elie HERBERICHS, eherberichs@novi-advisory.eu
'''
...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        dcc.Markdown(children=partie2_md)
    ], className="paragraph"),
